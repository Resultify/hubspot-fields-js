...
function secondaryButtonGroup () {
  return (

    group('Secondary button', 'secondary_button', {},
      fi.text('Text', 'text'),
      fi.link('Link', 'link'),
      ...
      group('Icon', 'icon',
        {
          display_conditions: {
            visibility: {
              controlling_field_path: 'secondary_button.text',
              operator: 'NOT_EMPTY'
            }
          }
        },
          ...
          display_conditions: {
            visibility: {
              controlling_field_path: 'secondary_button.icon.icon',
              operator: 'NOT_EMPTY',
              property: 'name'
            }
          }
...
export { secondaryButton, secondaryButtonGroup }
