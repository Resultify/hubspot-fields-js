 ...
 * @property {boolean} [allow_new_line] `true` Allows new line
 ...
 * @property {Object} [default.url] Default URL object
 * @property {string} [default.url.content_id] Default URL content ID
 * @property {string} default.url.type Default URL type
 * @property {string} [default.url.href] Default URL href
 * @property {boolean} [default.open_in_new_tab] Default open_in_new_tab value
 * @property {boolean} [default.no_follow] Default no_follow value
 * @property {boolean} [default.sponsored] Default sponsored value
 * @property {boolean} [default.user_generated_content] Default user_generated_content value
 */
 ...
 * @property {string} default.type Default type
