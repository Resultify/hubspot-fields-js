 ...
 * @private
 * @param {Array<T.BASE_FIELDS | T.BASE_GROUP_FIELDS>} array - array of objects
 * @param {string} [prefix] - prefix
 * @returns {Array<T.BASE_FIELDS | T.BASE_GROUP_FIELDS>} portal name|names
 */
 ...
 * @param {Array<T.BASE_FIELDS | T.BASE_GROUP_FIELDS>} childrens
 * @returns undefined
 * @example
 *  initModule(
 *    styleGroup(
