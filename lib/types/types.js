 ...
 * #### Advanced visibility
 * @memberof Types
 * @typedef {Object} DISABLED_CONTROLS
 * @property {string} [message] The message to display in the content editor when the field is disabled.
 * @property {Object} rules The conditions for enabling the field for editing.
 * @property {'AND'|'OR'} [rules.boolean_operator] The boolean operator for the conditional criteria. Can be AND or OR. When not specified, defaults to AND.
 * @property {Array<DISABLED_CONTROLS_CRITERIA>} [rules.criteria] An array of condition objects that defines the criteria that needs to be met for the field to display. This array can contain multiple condition objects separated by AND orOR logic through the boolean_operator parameter.
 */

/**
 * #### Advanced visibility criteria
 * @memberof Types
 * @typedef {Object} DISABLED_CONTROLS_CRITERIA
 * @property {string} [controlling_field_path] Path of the field that controls the display condition
 * @property {'NOT_EQUAL'|'EQUAL'|'EMPTY'|'NOT_EMPTY'|'MATCHES_REGEX'} operator
 * @property {string} [controlling_value_regex] The regular expression in the controlling field that needs to be present for the field to display.
 * @property {string} [property] Sets visibility based on a specific property (`src`, `name`)
 ...
 * @property {'half_width'|null} [display_width] Side by side fields
 ...
 * @property {DISABLED_CONTROLS} [disabled_controls] Disable the field for editing in the content editor.
 */
 ...
 * @property {string|number|Array<string|number>|null} [default]
 ...
 * @property {Object|Array<Object>|null} [default]
 ...
 * @property {string} [placeholder]
 * @property {number|Array<number>|null} [default]
 */
 ...
 * @property {Array<string>|null} [default]
 ...
 * @property {Array<string>} [embed_versions]
 ...
 * @property {string} [placeholder]
 * @property {string|number|null} [default]
 */
 ...
 * @property {string} [placeholder]
 * @property {number|string|null} [default]
 */
