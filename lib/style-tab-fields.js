 ...
 * @param {ALIGNMENT_CONTENT_OPTIONS & T.FAKE_STYLE_FIELDS_MAP} [fields]
 * @returns {T.BASE_FIELDS}
 * @typedef {Object} ALIGNMENT_CONTENT_OPTIONS
 ...
 * @param {T.FIELD_LABEL} label
 * @param {T.FIELD_NAME} name
 * @param {SPACING_CONTENT_OPTIONS & T.FAKE_STYLE_FIELDS_MAP} [fields]
 * @returns {T.BASE_FIELDS}
 * @typedef {Object} SPACING_CONTENT_OPTIONS
 ...
 * @param {T.FIELD_LABEL} label
 * @param {T.FIELD_NAME} name
 * @param {GRADIENT_CONTENT_OPTIONS & T.FAKE_STYLE_FIELDS_MAP} [fields]
 * @returns {T.BASE_FIELDS}
 * @typedef {Object} GRADIENT_CONTENT_OPTIONS
 ...
 * @property {Array<{color: RGBA_COLOR}>} [default.colors] Default colors array
 */
 ...
 * @param {T.FIELD_LABEL} label
 * @param {T.FIELD_NAME} name
 * @param {BACKGROUNDIMAGE_CONTENT_OPTIONS & T.FAKE_STYLE_FIELDS_MAP} [fields]
 * @returns {T.BASE_FIELDS}
 * @typedef {Object} BACKGROUNDIMAGE_CONTENT_OPTIONS
 ...
 * @param {T.FIELD_LABEL} label
 * @param {T.FIELD_NAME} name
 * @param {BORDER_CONTENT_OPTIONS & T.FAKE_STYLE_FIELDS_MAP} [fields]
 * @returns {T.BASE_FIELDS}
 * @typedef {Object} BORDER_CONTENT_OPTIONS
 ...
 * @param {T.FIELD_LABEL} label
 * @param {T.FIELD_NAME} name
 * @param {TEXTALIGNMENT_CONTENT_OPTIONS & T.FAKE_STYLE_FIELDS_MAP} [fields]
 * @returns {T.BASE_FIELDS}
 * @typedef {Object} TEXTALIGNMENT_CONTENT_OPTIONS
