...
/**
 * @summary Style group fields
 * @typedef {Object} STYLE_GROUP_FIELDS
 * @property {string} id
 * @property {string} name
 * @property {string} label
...
/**
 * @typedef {Object} FFFF
 * @property {REQUIRED_GROUP_FIELDS} REQUIRED_GROUP_FIELDS
 * @property {REQUIRED_GROUP_FIELDS} EDITOR_OPTIONS
 * @property {DISPLAY_CONDITIONS} DISPLAY_CONDITIONS
 * @property {REPEATER_OPTIONS} REPEATER_OPTIONS
 */
